...
import ProtectedRouteFarmer from "@/app/protected/protectedRouteFarmer";
import {
  Sheet,
  SheetContent,
  SheetHeader,
  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="mt-auto bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10 rounded-3xl p-6">
        <p className="text-xs font-semibold text-primary mb-1">Partner Support</p>
        <p className="text-[11px] text-muted-foreground mb-4">Need help managing your inventory?</p>
        <Link
          href="/contact"
          ...
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent side="left" className="w-[300px] sm:w-[350px] p-6 pt-12">
              <SheetHeader className="mb-8 text-left">
                <SheetTitle className="text-2xl font-black tracking-tighter">Navigation Hub</SheetTitle>
              </SheetHeader>
              <SidebarContent
                user={user}
                isLoading={isLoading}
