...
export const InfoCard = ({ icon: Icon, label, value }: InfoCardProps) => (
  <div className="flex items-center gap-4 p-5 rounded-[2rem] bg-muted/20 border border-border/20 transition-all hover:bg-muted/30 hover:border-primary/20 group shadow-sm">
    ...
    <div className="flex flex-col">
      ...
      <p className="text-sm font-bold text-foreground leading-none">{value || "Not set"}</p>
    </div>
  </div>
);
